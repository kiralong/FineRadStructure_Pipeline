...
setwd("~/Google Drive/Bioinformatics/Stacks-2.60/chapter_1/fineradstructure") ## The directory where the files are located
...
treefile<-"populations.haps_chunks.mcmTree.xml" ## finestructure tree file
### 2) EDIT THIS PATH TO WHERE YOU WANT THE PLOTS:
plotsFolder <- "~/Google Drive/Bioinformatics/Stacks-2.60/chapter_1/fineradstructure"
...
source("~/Google Drive/Bioinformatics/Stacks-2.60/chapter_1/fineradstructure/FinestructureLibrary.R", chdir = TRUE) # read in the R functions, which also calls the needed packages
